...
$picotse_layout_defaults = Picotse_Layout_Settings::get_defaults();
$picotse_layout_prefix   = isset($picotse_layout_prefix) ? $picotse_layout_prefix : 'params[rootLayout]';
?>
<div class="pts-root-layout">
    ...
    <table class="form-table pts-root-layout-table">
        <tr>
            ...
            <td>
                <input type="text" id="pts-siteMaxWidth" name="<?php echo esc_attr($picotse_layout_prefix); ?>[siteMaxWidth]" value="<?php echo esc_attr($picotse_layout_defaults['siteMaxWidth']); ?>" class="regular-text">
        ...
        <tr>
            ...
            <td>
                <input type="text" id="pts-contentWidth" name="<?php echo esc_attr($picotse_layout_prefix); ?>[contentWidth]" value="<?php echo esc_attr($picotse_layout_defaults['contentWidth']); ?>" class="regular-text pts-sync-content-size">
        ...
        <tr>
            ...
            <td>
                <input type="text" id="pts-wideWidth" name="<?php echo esc_attr($picotse_layout_prefix); ?>[wideWidth]" value="<?php echo esc_attr($picotse_layout_defaults['wideWidth']); ?>" class="regular-text pts-sync-wide-size">
        ...
        <tr>
            ...
            <td>
                <input type="text" id="pts-paddingInline" name="<?php echo esc_attr($picotse_layout_prefix); ?>[paddingInline]" value="<?php echo esc_attr($picotse_layout_defaults['paddingInline']); ?>" class="regular-text">
        ...
        <tr>
            ...
            <td>
                <input type="text" id="pts-blockGap" name="<?php echo esc_attr($picotse_layout_prefix); ?>[blockGap]" value="<?php echo esc_attr($picotse_layout_defaults['blockGap']); ?>" class="regular-text">
